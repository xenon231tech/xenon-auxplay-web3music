...
**⚖️ This project is licensed under AGPL-3.0. See [LICENSE](LICENSE) for details.**
...
This project is licensed under the GNU Affero General Public License v3.0. By using this software, you agree to:

- ✅ Share modifications publicly
- ✅ Disclose source code if deployed
- ✅ Use under same license
- ✅ Attribute the original authors

**Commercial licenses available**: For commercial use without AGPL obligations, contact commercial@auxplay.io
